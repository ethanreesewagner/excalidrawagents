    ...
    <>
      ...
      <DropdownMenu open={isExtraToolsMenuOpen}>
        ...
        >
          ...
          {app.props.aiEnabled !== false && app.props.onAIAutocompleteRequest && (
            <DropdownMenu.Item
              onSelect={() => {
                if (app.state.editingTextElement) {
                  ...
                  setAppState({ openSidebar: { name: "default", tab: "aiedit" } });
                }
              }}
              icon={brainIcon}
              data-testid="toolbar-ai-autocomplete"
              badge={<DropdownMenu.Item.Badge>AI</DropdownMenu.Item.Badge>}
            >
              {t("labels.aiAutocomplete")} (⌘.)
            </DropdownMenu.Item>
          )}
